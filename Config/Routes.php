...
return [
    ...
    ['GET', '/mot-de-passe-oublie', [], Controller\HomeController::class, "forgottenPassword"],
    ...
    ['POST', '/admin/users/change-password/', ['\d+'], Admin\AdminUserController::class, "changePassword"],
